...
<p class="mb-0 text-muted">{{$v->recruiter_first_name}} {{$v->recruiter_last_name}}</p>

</div>
<div class="p-4">
    <a href="" ><button type="submit" class="btn btn-success"><i c></i>Edit Post</button> </a>
...
<p class="mb-0 mt-0 small">{{$v->recruiter_number}}</p>
<h6 class="m-1">Email</h6>
<p class="mb-0 mt-0 small">{{$v->email}}</p>
...
<textarea class="form-control" rows="4" name="text" placeholder="Enter Bio">{{$v->company_name}}</textarea>
</div>
</div>
